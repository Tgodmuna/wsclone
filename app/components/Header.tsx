      ...
      <div
        ...
        <div
          ...
          <div
            ...
            />
            <span className={`text-sm font-light ${isSticky ? "text-[#0633ec]" : "text-white"}`}>
              Upskilling Bharat
            </span>
          </div>
          ...
          <div className="flex items-center gap-6">
            <button
              className={`border px-4 py-1.5 rounded-lg flex items-center gap-1 ${
                isSticky ? "text-[#0633ec] border-[#0633ec]" : "text-white border-white"
              }`}>
              Explore Courses <ChevronDown size={16} />
            </button>
            <button
              className={`flex items-center gap-1 ${isSticky ? "text-[#0633ec]" : "text-white"}`}>
          ...
          {/* Login Button */}
          <button
            className={`border px-4 py-1.5 rounded-lg hover:bg-white transition ${
              isSticky
